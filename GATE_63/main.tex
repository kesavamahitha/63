...
Mathematically,
\begin{equation*}
I(\sigma^2) = -E\left [\frac{\partial^2}{\partial(\sigma)^2}\log f(X|\sigma^2)\right]
\end{equation*}
where, $E[\cdot]$ represents the expected value and $f(X|\sigma^2)$ is the p.d.f of random variable $X$ given the parameter $\sigma^2$. 
\end{definition}
\begin{definition}
